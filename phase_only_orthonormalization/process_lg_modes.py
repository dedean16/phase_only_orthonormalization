...
do_export_modes = False

import_filepath = '\\\\ad.utwente.nl/TNW/BMPI/Data/Daniel Cox/ExperimentalData/wfs-OrthoFBDR-comparison/ortho-lg-verygood.hdf5'
export_filepath = '/home/dani/LocalData/ortho-lg-hires.hdf5'
...
from mode_functions import compute_non_orthonormality
non_orthogonality, gram = compute_non_orthonormality(torch.tensor(new_modes))
pass
